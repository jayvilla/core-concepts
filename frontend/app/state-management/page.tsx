        ...
        <div className="mb-8">
          ...
          <div className="text-center">
            ...
            <p className="text-lg text-gray-800 max-w-3xl mx-auto">
              Understanding useState, useReducer, and Context API. Learn when to
            ...
            <div>
              ...
              <ul className="text-sm space-y-2">
                ...
                <li>
                  ...
                  useReducer. Sharing across many components → Context. Complex shared state → useReducer in Context.
                </li>
                <li>
                  ...
                  depending on previous state. Keep reducers pure (no side effects).
                </li>
              </ul>
            </div>
